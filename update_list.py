...
YASAKLI_GRUPLAR = [
    ...
    # İÇİNDE "GLIFE" GEÇEN BÜTÜN KANALLARI/GRUPLARI KÖKTEN SİLER
    "GLIFE"
]
...
HAVUZ_YASAKLI_KELIMELER = [
    ...
    # İÇİNDE "GLIFE" GEÇEN BÜTÜN KANALLARI/URL'LERİ KÖKTEN SİLER
    "GLIFE"
]
...
def main():
    ...
    print(f"\n🏁 İŞLEM BİTTİ USTA! Zırhlı listen %100 korundu. Sağlam kanallar eklendi.")
