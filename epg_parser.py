...
def parse_epg():
    print("Goldvod verisi senin m3u listene göre ayıklanıyor...")
    ...
    # SENİN M3U DOSYANDAKİ BİREBİR tvg-id DEĞERLERİ
    mapping = {
    ...
    for programme in root.findall('programme'):
        ...
        # Goldvod verisini m3u'daki gibi STARTV.tr vb. şeklinde kontrol et
